...
if __name__ == '__main__':
    ...
    print("**** SWAPI **** \n")
    print('¿En cúantas peliculas aparecen planetas cuyo clima sea árido?')
    print(len(movie))
    print('¿Cúantos wookies aparecen en la sexta pelicula?')
    print(len(WookieInMovie))
    print('¿Cúal es el nombre de la aeronave mas grande en toda la saga?')
    print(ships['name'])
